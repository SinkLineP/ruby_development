...
def grid
	...
	while  true
	    puts grid
		puts "Пример ввода (a1, b2, c3).<br>"
		puts "Первый игрок 'X'<br>"
		print "Введите ячейку: <label> </label> <br>"
		...
		while true
		    ...
		    if @a == "a1" && @a1 == " "
				...
				puts "Выберите другую ячейку: <br>"			
			end
	   	end
				puts grid
			...
			if @a1 != " " && @a2 != " " && @a3 != " " && @b1 != " " && @b2 != " " && @b3 != " " && @c1 != " " && @c2 != " " && @c3 != " "
				...
				@c2 = " "
				@c3	= " "
					puts "Хотиет ли вы продолжить игру (Y/N)<br>"
					@var = gets.chomp!
						if @var == "Y<br>"
							puts "        ==================      <br> "
							puts grid
						else 
							puts "Хорошая игра была!!!<br>"
							puts "Удачи, будем ждать ещё!<br>"
							exit
						end
			end
